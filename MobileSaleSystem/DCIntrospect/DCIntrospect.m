...
- (void)setInvokeAllOutlinesGestureRecognizer:(UIGestureRecognizer *)newGestureRecognizer
{
    UIWindow *mainWindow = [self mainWindow];
    [mainWindow removeGestureRecognizer:self.invokeAllOutlinesGestureRecognizer];
    _invokeAllOutlinesGestureRecognizer = newGestureRecognizer;
    [self.invokeAllOutlinesGestureRecognizer addTarget:self action:@selector(invokeAllOutlinesIntrospector)];
    [mainWindow addGestureRecognizer:self.invokeAllOutlinesGestureRecognizer];
}
...
- (void)invokeAllOutlinesIntrospector
{
    [self toggleOutlines];
}
